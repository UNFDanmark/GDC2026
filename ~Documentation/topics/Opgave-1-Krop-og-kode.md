...
Hvis vi kigger i projekt vinduet kan i se at vi allerede har tilføjet nogle filer for jer, deriblandt en scene for hver faggruppe. Som udgangspunkt så skal det endelige spil være i "Programming" scenen.
